...
Specialized diagnostics should import their concrete submodules directly. Keeping
``app.makro`` small prevents unrelated helpers from breaking every Makro import.
"""

from .domain import MakroDomainAdapter
from .fields import build_semantic_fields, derive_attribute_key
from .listing import (
    MAKRO_HOME_URL,
    MakroListingTarget,
